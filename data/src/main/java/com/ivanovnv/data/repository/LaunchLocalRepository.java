...
import static com.ivanovnv.domain.model.filter.IAnalyticsFilter.ItemType.LAUNCH_COUNT;
import static com.ivanovnv.domain.model.filter.IAnalyticsFilter.ItemType.PAYLOAD_WEIGHT;
import static com.ivanovnv.domain.model.filter.IAnalyticsFilterItem.BaseType.COUNTRIES;
import static com.ivanovnv.domain.model.filter.IAnalyticsFilterItem.BaseType.MISSIONS;
import static com.ivanovnv.domain.model.filter.IAnalyticsFilterItem.BaseType.ORBITS;
import static com.ivanovnv.domain.model.filter.IAnalyticsFilterItem.BaseType.ROCKET;
import static com.ivanovnv.domain.model.filter.IAnalyticsFilterItem.BaseType.YEARS;
import static com.ivanovnv.domain.model.filter.ISearchFilter.ItemType.BY_COUNTRY;
import static com.ivanovnv.domain.model.filter.ISearchFilter.ItemType.BY_LAUNCH_YEAR;
import static com.ivanovnv.domain.model.filter.ISearchFilter.ItemType.BY_MISSION_NAME;
import static com.ivanovnv.domain.model.filter.ISearchFilter.ItemType.BY_ORBIT;
import static com.ivanovnv.domain.model.filter.ISearchFilter.ItemType.BY_ROCKET_NAME;
